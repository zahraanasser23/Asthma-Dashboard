...
# Create a selectbox for data set selection
selected_data_set = st.selectbox("Select a Data Set", list(data_sets.keys()))

# Load and preprocess the selected data set
